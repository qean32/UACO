    ...
    return (
        <>
            <div onClick={onClickItem}
                className={cn("fixed top-0 left-0 bottom-0 right-0 bg-black/50 z-30 transition-opacity duration-200",
            ...
            <div className={cn('flex rounded-2xl justify-between relative h-11 z-30', className)}>
                ...
                <input className="rounded-sm w-175 outline-none bg-gray-100 pl-11"
                    type="text"
                ...
                {!!students.length && (
                    <div className={cn('absolute w-full bg-white rounded-sm py-2 top-14 shadow-md transition-all duration-200 invisible opacity-0 z-30',
